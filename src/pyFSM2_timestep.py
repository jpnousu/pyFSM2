...
class pyFSM2_Timestep():
    def __init__(self):
        ...
        self.Ncnpy,             # Number of canopy layers
        self.Nsmax,             # Maximum number of snow layers
...
real :: &
  ...
  SWveg(Ncnpy)        ! SW absorbed by vegetation layers (W/m^2)
    ...
    def run_timestep(self, dt, zT, zU, elev, LW, Ps, Qa, Rf, Sdif, Sdir,
                     Ta, trans, Ua, Sf, alb0, vegh, VAI):
      

  FSM2_TIMESTEP(dt,elev,zT,zU,                                &
